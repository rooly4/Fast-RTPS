...
bool LivelinessPublisher::init(LivelinessQosPolicyKind liveliness)
{
    topic_.index(0);
    ...
    Wparam.qos.m_liveliness.lease_duration = Duration_t(2);
    Wparam.qos.m_liveliness.announcement_period = Duration_t(1);
    Wparam.qos.m_liveliness.kind = liveliness;
