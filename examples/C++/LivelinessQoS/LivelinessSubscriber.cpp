...
bool LivelinessSubscriber::init(LivelinessQosPolicyKind liveliness_kind)
{
    ...
    Rparam.qos.m_liveliness.lease_duration = Duration_t(2);
    Rparam.qos.m_liveliness.announcement_period = Duration_t(1);
    Rparam.qos.m_liveliness.kind = liveliness_kind;
